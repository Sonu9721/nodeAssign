...
//  step2:[BEST PRACTISE]:- always write s2 upload function separately-
//in a separate file/function..exptect it to take file as input and return the uploaded file as output
...
// -how to write promise:- wrap your entire code inside: "return new Promise( function(resolve, reject) 
//{ "...and when error - return reject( err )..else when all ok and you have data, return resolve (data)


aws.config.update({//wherever we are uploding the files are define in configFile
    region: "ap-south-1",
